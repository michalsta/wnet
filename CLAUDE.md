...
- `add_simple_trash(cost)` — a single `Source→Sink` escape arc per subgraph; any unmatched unit on either side escapes at `cost`. This is the Truncated Wasserstein distance.
