...
NB_MODULE(wnet_cpp, m) {
    ...
    nb::class_<WassersteinNetworkSubgraph<int64_t, int64_t>>(m, "CWassersteinNetworkSubgraph")
        ...
        // Standalone (per-subgraph) derivatives use this subgraph's own Xe/Xt.
        .def("signal_part_derivatives", [](const WassersteinNetworkSubgraph<int64_t, int64_t>& s) { return s.signal_part_derivatives(); })
        .def("spectrum_proportion_derivatives", [](const WassersteinNetworkSubgraph<int64_t, int64_t>& s) { return s.spectrum_proportion_derivatives(); })
        .def("signal_part_derivatives_fast_approx", [](const WassersteinNetworkSubgraph<int64_t, int64_t>& s) { return s.signal_part_derivatives_fast_approx(); })
        .def("spectrum_proportion_derivatives_fast_approx", [](const WassersteinNetworkSubgraph<int64_t, int64_t>& s) { return s.spectrum_proportion_derivatives_fast_approx(); })
        ...
        .def("signal_part_derivatives", [](const WassersteinNetworkSubgraph<int64_t, double>& s) { return s.signal_part_derivatives(); })
        .def("spectrum_proportion_derivatives", [](const WassersteinNetworkSubgraph<int64_t, double>& s) { return s.spectrum_proportion_derivatives(); })
        .def("signal_part_derivatives_fast_approx", [](const WassersteinNetworkSubgraph<int64_t, double>& s) { return s.signal_part_derivatives_fast_approx(); })
        .def("spectrum_proportion_derivatives_fast_approx", [](const WassersteinNetworkSubgraph<int64_t, double>& s) { return s.spectrum_proportion_derivatives_fast_approx(); })
