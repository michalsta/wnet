...
NB_MODULE(wnet_cpp, m) {
    ...
    nb::class_<WassersteinNetworkSubgraph<int64_t, int64_t>>(m, "CWassersteinNetworkSubgraph")
        ...
        .def("build", nb::overload_cast<>(&WassersteinNetworkSubgraph<int64_t, int64_t>::build))
        .def("build", nb::overload_cast<SolverMethod>(&WassersteinNetworkSubgraph<int64_t, int64_t>::build), nb::arg("method"))
        ...
        .def("build", nb::overload_cast<>(&WassersteinNetworkSubgraph<int64_t, double>::build))
        .def("build", nb::overload_cast<SolverMethod>(&WassersteinNetworkSubgraph<int64_t, double>::build), nb::arg("method"))
    ...
    nb::class_<WassersteinNetwork<int64_t, int64_t>>(m, "CWassersteinNetwork")
        ...
        .def("build", nb::overload_cast<>(&WassersteinNetwork<int64_t, int64_t>::build))
        .def("build", nb::overload_cast<SolverMethod>(&WassersteinNetwork<int64_t, int64_t>::build), nb::arg("method"))
    ...
    nb::class_<WassersteinNetwork<int64_t, double>>(m, "CWassersteinNetworkFloat")
        ...
        .def("build", nb::overload_cast<>(&WassersteinNetwork<int64_t, double>::build))
        .def("build", nb::overload_cast<SolverMethod>(&WassersteinNetwork<int64_t, double>::build), nb::arg("method"))
