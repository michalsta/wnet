...
NB_MODULE(wnet_cpp, m) {
    ...
    nb::class_<WassersteinNetworkSubgraph<int64_t, int64_t>>(m, "CWassersteinNetworkSubgraph")
        ...
        .def("local_dist_src_to_sink", &WassersteinNetworkSubgraph<int64_t, int64_t>::local_dist_src_to_sink, nb::arg("fast") = false)
        .def("local_dist_sink_to_src", &WassersteinNetworkSubgraph<int64_t, int64_t>::local_dist_sink_to_src, nb::arg("fast") = false)
        .def("source_supply", &WassersteinNetworkSubgraph<int64_t, int64_t>::source_supply)
        .def("simple_trash_flow", &WassersteinNetworkSubgraph<int64_t, int64_t>::simple_trash_flow)
        .def("exp_trash_flow_sum", &WassersteinNetworkSubgraph<int64_t, int64_t>::exp_trash_flow_sum)
        .def("theo_trash_flow_sum", &WassersteinNetworkSubgraph<int64_t, int64_t>::theo_trash_flow_sum)
        .def("match_cost", &WassersteinNetworkSubgraph<int64_t, int64_t>::match_cost)
        .def("match_flow", &WassersteinNetworkSubgraph<int64_t, int64_t>::match_flow)
